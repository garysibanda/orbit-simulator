...
double Position::metersFromPixels;
...
//// Position equation, thanks to Brother Helfrich
//
//void Position::updatePosition(const Acceleration& a, const Velocity& v, double t)
//{
